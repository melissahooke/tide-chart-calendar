...
```{r}
year = '2020'
location = 'westport-harbor-ma'
dir.create(paste("Output",year,'-',location,sep=""))
```


```{r}
tide = read.csv('tide-chart-westport-harbor-ma-2020.csv')
tide$fullDate = paste(tide$Month,'-',tide$Date,'-2020',sep = '')
